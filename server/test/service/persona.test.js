...
describe('/api/personas/*', () => {
  ...
  //       const response = await request({ path, method, body });
  //       expect(await response.json()).toMatchInlineSnapshot();
  //       expect(db.getPersona.mock.calls.length).toBe(0);
  ...
  //       expect(db.getPersona.mock.calls[0]).toMatchInlineSnapshot(`
  //         Array [
  //           1,
  //         ]
  //       `);
  ...
  // describe('/api/personas/:id/scenarios', () => {
  //   const path = '/api/personas/1/scenarios';
  //   const method = 'post';
  ...
  // describe('/api/personas/all (get)', () => {
  //   const path = '/api/personas/all';

  //   test('success', async () => {
  //     const response = await request({ path });
  //     expect(await response.json()).toMatchInlineSnapshot();
  //     expect(db.getAllCohorts.mock.calls.length).toBe(1);
  //     expect(db.getAllCohorts.mock.calls[0]).toMatchInlineSnapshot(`Array []`);
  //   });
  // });

  // describe('/api/personas/:id/scenario/:scenario_id/:user_id (get)', () => {
  //   const path = '/api/personas/1/scenario/42/999';

  //   test('success', async () => {
  //     const response = await request({ path });
  //     expect(await response.json()).toMatchInlineSnapshot();
  //     expect(db.getPersonaRunResponses.mock.calls.length).toBe(1);
  //     expect(db.getPersonaRunResponses.mock.calls[0]).toMatchInlineSnapshot(`
  //       Array [
  //         Object {
  //           "id": "1",
  //           "scenario_id": "42",
  ...
  // describe('/api/personas/:id/scenario/:scenario_id (get)', () => {
  //   const path = '/api/personas/1/scenario/42';
  ...
  // describe('/api/personas/:id/participant/:participant_id (get)', () => {
  //   const path = '/api/personas/1/participant/99';
  ...
  // describe('/api/personas/:id/run/:run_id (get)', () => {
  //   const path = '/api/personas/1/run/42';
  ...
  //       ]
  //     `);
  //     expect(db.getPersona.mock.calls.length).toBe(1);
  //     expect(db.getPersona.mock.calls[0]).toMatchInlineSnapshot(`
  //       Array [
  //         1,
  //       ]
  ...
  // describe('/api/personas/:id/join/:role (get)', () => {
  //   const path = '/api/personas/1/join/participant';
  ...
  // describe('/api/personas/:id/quit (get)', () => {
  //   const path = '/api/personas/1/quit';
  ...
  // describe('/api/personas/:id/done (get)', () => {
  //   const path = '/api/personas/1/done';
