...
export const description =
  'Embed a video (from YouTube) that prompts the participant to respond immediately after it completes playback. Audio recording and transcript data is collected.';
