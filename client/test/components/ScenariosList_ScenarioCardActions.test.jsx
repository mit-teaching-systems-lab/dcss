...
import ScenarioCardActions from '../../components/ScenariosList/ScenarioCardActions.jsx';
...
test('ScenarioCardActions', () => {
  expect(ScenarioCardActions).toBeDefined();
});
...
test('Snapshot 1', () => {
  ...
  const mounted = mounter(reduxer(ScenarioCardActions, props, state))();
