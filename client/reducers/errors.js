...
const errorActionsMap = {
  chat: [GET_CHAT_ERROR, SET_CHAT_ERROR, LINK_RUN_TO_CHAT_ERROR],
  chats: [GET_CHATS_ERROR],
  ...
  users: [GET_USERS_ERROR, GET_USERS_COUNT_ERROR, GET_USERS_BY_PERMISSION_ERROR]
};
